  ...
  <?php else: ?>
    ...
    <?php if (setting("DAFTAR_ANGGOTA","status") != "1"): ?>
      ...
      <?php else: ?>
        ...
        <form class="mt-3" id="form" action="<?=site_url("frontend/anggota/verifikasi_action/".enc_uri($row->id_anggota))?>" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="no_tlp" name="no_tlp" value="<?=$row->no_hp?>">
          </div>
          ...
          <div class="mt-5 text-center">
            ...
            <button type="submit" id="submit" name="submit" class="btn btn-primary btn-md">Verifikasi</button>
          </div>
