<form id="form" action="<?=site_url("frontend/account/pass_login_action")?>" autocomplete="off">
  ...
  <div class="mt-5 text-center">
    ...
    <button type="submit" id="submit" name="submit" class="btn btn-primary btn-md">Ubah Password Login</button>
  </div>
</form>
